...
const CalendarHeader = createReactClass({
  ...
  render() {
    ...
    }, this.displayingMinMonth() ? null : this.props.previousButtonElement), React.createElement("span", null, this.props.monthLabels[this.props.displayDate.getMonth()], " ", this.props.displayDate.getFullYear()), React.createElement("div", {
...
const Calendar = createReactClass({
  ...
  render() {
    ...
    const startingDay = this.props.weekStartsOn > 1 ? firstDay.getDay() - this.props.weekStartsOn + 7 : this.props.weekStartsOn === 1 ? firstDay.getDay() === 0 ? 6 : firstDay.getDay() - 1 : firstDay.getDay();
    ...
    for (let i = 0; i < 9; i++) {
      ...
      if (showWeeks) {
        ...
        week.unshift(React.createElement("td", {
          key: 7,
          style: {
            padding: this.props.cellPadding,
            fontSize: '0.8em',
    ...
    const weekColumn = showWeeks ? React.createElement("td", {
    ...
    return React.createElement("table", {
      className: "text-center"
    }, React.createElement("thead", null, React.createElement("tr", null, weekColumn, this.props.dayLabels.map((label, index) => {
    ...
    }))), React.createElement("tbody", null, weeks), this.props.showTodayButton && React.createElement("tfoot", null, React.createElement("tr", null, React.createElement("td", {
...
export default createReactClass({
  ...
  makeInputValueString(date) {
    ...
    const day = date.getDate(); //this method is executed during intialState setup... handle a missing state properly
  ...
  render() {
    const calendarHeader = React.createElement(CalendarHeader, {
    ...
    const control = this.props.customControl ? React.cloneElement(this.props.customControl, {
    ...
    }, control, React.createElement(Overlay, {
      rootClose: true,
    ...
    }), this.props.showClearButton && !this.props.customControl && React.createElement(InputGroup.Addon, {
